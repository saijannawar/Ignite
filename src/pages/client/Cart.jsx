              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between items-center text-sm text-gray-600">
                    <span>Subtotal</span>
                    <span className="font-bold text-[#7D2596]">₹{cartTotal}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm text-gray-600">
                    <span>Shipping</span>
                  ...
                  <div className="border-t border-gray-100 pt-4 flex justify-between items-center">
                    ...
                    <span className="text-xl font-bold text-[#7D2596]">₹{cartTotal}</span>
                  </div>
                </div>

                <button 
                  onClick={() => navigate('/checkout')}
                  className="w-full py-4 bg-[#7D2596] text-white font-bold rounded shadow-lg hover:bg-[#631d76] transition-transform active:scale-[0.99] uppercase flex items-center justify-center gap-2"
                >
